...
class RankManagerTest {
    ...
    void testPromote() {
        ...
        IRank newRank = rankManager.promote(player).join();
    ...
    void testDemote() {
        ...
        IRank newRank = rankManager.demote(player).join();
